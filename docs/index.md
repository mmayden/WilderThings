...
- **[Glossary](references/glossary.md)** — Key terms defined.
- **[Checklists](references/checklists/first-aid-checklist.md)** — Quick-reference field checklists.
- **[Book List](references/book-list.md)** — Recommended reading.
- **[Sources](references/sources.md)** — Where the information comes from.

## Principles

Every guide in this collection follows these rules:
